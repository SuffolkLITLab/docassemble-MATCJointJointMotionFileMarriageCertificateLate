...
setup(name='docassemble.MATCJointJointMotionFileMarriageCertificateLate',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/MATCJointJointMotionFileMarriageCertificateLate/', package='docassemble.MATCJointJointMotionFileMarriageCertificateLate'),
     )
